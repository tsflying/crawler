...
import com.mff.weibo.model.Proxy;
import com.mff.weibo.model.Twitter;
    ...
    public HttpsUtil(Proxy proxy, String cks, String domain) {
        ...
        if (StringUtils.isNotBlank(profile) && profile.equals("dev")) {
            registry = RegistryBuilder.<ConnectionSocketFactory>create()
                    .register("http", new HttpUtil.MyConnectionSocketFactory())
                    .register("https", new HttpUtil.MySSLConnectionSocketFactory(SSLContexts.createSystemDefault())).build();
        } else {
